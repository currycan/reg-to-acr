...
all:
	gox -osarch="darwin/amd64 linux/386 linux/amd64" \
        ...
        -ldflags   "-X 'github.com/currycan/reg-to-acr/cmd.version=${BUILD_VERSION}' \
					-X 'github.com/currycan/reg-to-acr/cmd.buildTime=${BUILD_TIME}' \
					-X 'github.com/currycan/reg-to-acr/cmd.commit=${COMMIT_SHA1}'"
